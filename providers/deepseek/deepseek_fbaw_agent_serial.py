...
class PersistentEngineeringBridge:
    ...
    def __init__(self, cache_dir: Path, enabled: bool = True):
        ...
        self.verify_cache_path = self.cache_dir / "verification_cache_v43.pkl"
        self.checkpoint_cache_path = self.cache_dir / "checkpoint_v43.pkl"
        self.verify_cache = {}
        self.stats = {
            "verify_requests": 0,
            "verify_cache_hits": 0,
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--cache-dir", default=".fbaw_v43_cache",
                   help="Persistent V4.3 engineering cache directory")
...
def main() -> int:
    ...
    report = {
        ...
        "agent_version": "V4.3_DeepSeek_PersistentBridge_Cache",
    ...
    print("\nV4.3 PYTHON BRIDGE / CACHE STATISTICS")
